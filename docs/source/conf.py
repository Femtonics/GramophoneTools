...
htmlhelp_basename = 'GramophoneToolsdoc'
...
latex_documents = [
    (master_doc, 'GramophoneTools.tex', 'GramophoneTools Documentation',
     'Femtonics Ltd.', 'manual'),
]
...
man_pages = [
    (master_doc, 'gramophonetools', 'GramophoneTools Documentation',
     [author], 1)
]
