...
The system can be used in conjunction with Femtonics SMART microscopes and certain custom built models. To get further information about compatibility with your device, please contact Femtonics Ltd. at \href{mailto:info@femtonics.eu}{info@femtonics.eu}.

\section{Links}
\begin{itemize}
\item Python Package Index - https://pypi.org/project/GramophoneTools
\item GitHub - https://github.com/Femtonics/GramophoneTools
\item Documentation - 
\item User guide - 
\end{itemize}
